...
std::string humanize_unsigned_double(const long double double_value, const int precision = 2) {
...
std::string monetize_integer(const unsigned long int integer_value, const bool prepend = true, const std::string &symbol = "$") {
...
std::string monetize_double(const long double double_value, const int precision = 2, const bool prepend = true, const std::string &symbol = "$") {
